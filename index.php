...
<head>
	...
	<title>Welcome to med DESK</title>
...
<body>
	<div class="wrapper">
		<nav class="navbar navbar-expand-lg navbar-light">
			<div class="container">
				<a class="navbar-brand" href="#">Med <b>DESK</b></a>
		...
		<div class="jumbotron jumbotron-fluid">
			<div class="container">
				<h2 class="jumbotron-title">All your healthcare in one space</h2>
				<p>Contact For Sales</p>
			</div>
		</div>
	...
	<footer class="footer">
		<div class="upper-footer">
			<div class="container">
				<div class="row">
					<div class="col-3">
						<a class="navbar-brand" href="#">med DESK</a>
					</div>
					<div class="col-3">
						<h5>Product</h4>
							<ul>
