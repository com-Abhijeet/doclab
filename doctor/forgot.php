			...
			<div class="login-body">
				<form name="forgot_form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
					...
					<div class="form-group">
						...
						<small id="emailHelp" class="form-text text-muted">Provide us the email id/ mobile of your med DESK account<br> We will send you an email with instructions to reset your password.</small>
					</div>
